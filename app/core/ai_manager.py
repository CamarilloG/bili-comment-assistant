...
class AIManager:
    ...
    def __init__(self, config: dict):
        ...
        # 控制台选择模式：智能评论/智能筛选任一开启且已填 api_key 即创建 provider
        has_key = bool((ai_cfg.get("api_key") or "").strip())
        ...
        self.provider = AIProvider(config) if (has_key and (need_comment or need_filter)) else None
