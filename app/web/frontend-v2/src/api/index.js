...
export const taskApi = {
  ...
  startDm: (slot) => api.post('/task/dm/start', null, { ...slotParams(slot), timeout: 120000 }),
  stopDm: (slot) => api.post('/task/dm/stop', null, slotParams(slot)),
  dmStatus: (slot) => api.get('/task/dm/status', slotParams(slot)),
}
