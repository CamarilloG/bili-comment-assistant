...
async def lifespan(app: FastAPI):
    ...
    print("Version: 3.11.0  Developer: CamarilloG  Repo: https://github.com/CamarilloG/bili-comment-assistant", flush=True)
...
from web.routers.dm_api import router as dm_api_router
...
app.include_router(dm_api_router, prefix="/api/task/dm", tags=["dm"])
